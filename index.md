...
da música, conforme o jogo apresenta as setas verticalmente
para o jogador. Este jogo é similar ao jogo DanceDanceRevolution, de quatro
teclas, mais popular no Japão e Estados Unidos, enquanto Pump it Up é
mais famoso em outras regiões do mundo.
Atualmente, existem múltiplos papers estudando a viabilidade
de uso de machine learning para a geração de níveis de DanceDanceRevolution, mas
nenhum deles aproveita a oportunidade para analisar a viabilidade de machine learning
no jogo Pump it Up, que possui mecânicas, velocidades, e granularidade de níveis
